  ...
  return (
    <>
      ...
      <div
        ...
        } fixed top-20 left-1/2 z-50 flex w-[95%] -translate-x-1/2 flex-col gap-4 rounded-2xl border border-white/10 bg-slate-900/80 p-6 shadow-2xl backdrop-blur-xl transition-all duration-300 ease-in-out md:top-24 md:right-[5%] md:left-auto md:w-64 md:translate-x-0`}
      >
