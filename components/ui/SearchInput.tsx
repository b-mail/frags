...
export default function SearchInput({
  ...
  return (
    ...
    >
      <input
        className="min-w-0 flex-grow rounded-2xl border-4 border-slate-700 bg-slate-800 px-4 py-2 placeholder:text-slate-500 focus:border-slate-500 focus:outline-0"
